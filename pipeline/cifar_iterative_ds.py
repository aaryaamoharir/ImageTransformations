...
def main():
    ...
    print("\n--- Now running dataset refinement process with Decision Change scores ---")
    
    dc_threshold = results['decision_change']['optimal_threshold']
    ...
    refined_dataloader = refine_dataset_with_uncertainty_metric(
        ...
        nn.CrossEntropyLoss(), 
        0.9, 
        uncertainty_data['decision_change'],
        1.0,
