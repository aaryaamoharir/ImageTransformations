...
for img, label in dataloader:
    ...
    #fgsm attack where it adds the epsilon 
    img_adv = img + eps * grad.sign()
    img_adv = torch.clamp(img_adv, 0, 1)  # Keep image in [0,1]
    ...
    with torch.no_grad():
        ...
        #store top 5 predictions to see if the actual classification is in the top 5 
